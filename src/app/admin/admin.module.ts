...
@NgModule({
  declarations: [AdminComponent, AdminLoginComponent, AdminMainComponent, AdminHistoryComponent, AdminPlayerUpdateComponent, AdminPlayerDbComponent, AdminCsvImportComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
