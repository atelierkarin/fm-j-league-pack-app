...
export class DatabaseEffects {
  ...
  searchPlayersByClub = createEffect(() =>
    this.actions$.pipe(
  ...
  loadLatestUpdatePlayers = createEffect(() =>
    this.actions$.pipe(
  ...
  loadLatestMostAccessed = createEffect(() =>
    this.actions$.pipe(
  ...
  loadPlayerHistory = createEffect(() =>
    this.actions$.pipe(
  ...
  loadPlayerHistoryNameByInfo = createEffect(() =>
    this.actions$.pipe(
